...
isc.Flashlet.addClassMethods({
    ...
    // @return (boolean) true if Flash is installed.
    // @visibility PluginBridges
    //<
    flashAvailable : function () {
        ...
        if (isc.Browser.isIE) {
            var vbScriptString = isc.StringBuffer.concat(
		    ...
		    'End If\n' ,
        	'Next');
            window.execScript(vbScriptString, "VBScript");
            
        } else {
            var flashPlugin = navigator.plugins["Shockwave Flash"];
            // Special case - version 2.0 had it's own name
...
getInnerHTML : function () {
    ...
    accum.append("<object classid='", this.classID, "' codebase='", this.codeBase,
