...
isc.addGlobal("addMethods", function (destination, source) {
    ...
    for (var name in source) {
        ...
        if (isc.isAn.Instance != null && method != null &&
...
isc._nameMethod = function (method, name, destination) {
    ...
    if (isc.isA != null && isc.isAn.InstancePrototype != null && 
    ...
    if (isc.isA != null && isc.isAn.Instance != null && isc.isAn.Instance(destination) &&
...
isc._fillNumber = function (template, number, startSlot, numSlots) {
