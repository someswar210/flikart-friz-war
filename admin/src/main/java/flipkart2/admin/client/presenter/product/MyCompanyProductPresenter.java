package flipkart2.admin.client.presenter.product;

import java.util.HashMap;

import flipkart2.admin.client.datasource.ShippingCountryListDataSourceFactory;
import flipkart2.admin.client.datasource.ShippingCountrySearchDataSourceFactory;
import flipkart2.admin.client.view.product.MyCompanyProductDisplay;
