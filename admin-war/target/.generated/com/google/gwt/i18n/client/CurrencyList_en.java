...
public class CurrencyList_en extends com.google.gwt.i18n.client.CurrencyList_ {
  ...
  protected HashMap<String, CurrencyData> loadCurrencyMapJava() {
    ...
    result.put("CNX", new CurrencyDataImpl("CNX", "CNX", 130));
    ...
    // Guinea-Bissau Peso
    result.put("GWP", new CurrencyDataImpl("GWP", "GWP", 130));
    // Guyanaese Dollar
    ...
    // Maldivian Rupee
    result.put("MVP", new CurrencyDataImpl("MVP", "MVP", 2));
    // Maldivian Rufiyaa
    ...
    result.put("UYI", new CurrencyDataImpl("UYI", "UYI", 130));
    ...
    result.put("XTS", new CurrencyDataImpl("XTS", "XTS", 130));
    ...
    result.put("ZWL", new CurrencyDataImpl("ZWL", "ZWL", 130));
  ...
  protected HashMap<String, String> loadNamesMapJava() {
    ...
    result.put("ALK", "Old Albanian Lek");
