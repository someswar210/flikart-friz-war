...
isc.RecordEditor.addMethods({
    ...
    performAction : function (suppressPrompt) {
        if (this.isAFilterEditor()) this.performFilter(suppressPrompt);
    ...
    setValuesAsCriteria : function (criteria, refresh) {
        ...
        form.setValuesAsCriteria(criteria);
    ...
    _getFilterCriteria : function (textMatchStyle) {
        ...
        return form.getValuesAsCriteria(null, textMatchStyle);
    },
...
//        );
    ...
    getEditItem : function (editField, record, editedRecord, rowNum, colNum, width) {
        ...
        var filterEditorProps = this.sourceWidget.getFilterEditorProperties(editField),
            undef;
    ...
    getCellAlign : function (record, rowNum, colNum) {
        if (colNum == this.fields.getLength() -1) {
            return "left"
        }
