...
//
// @param propertyName (String or Object) property to match, or if an Object is passed, set of
...
//<
duplicate : function () {
	return this.newInstance().addList(this);
},
...
isc._stealArrayMethods = function () {
    var methodList = [
                      ...
                      // find
                      "find", "findIndex", "findNextMatch", "findAllMatches", "findByKeys",
