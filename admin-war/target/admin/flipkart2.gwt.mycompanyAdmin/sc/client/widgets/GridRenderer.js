...
_$zIndexDivTemplate:["<DIV style='position:"+
                        
                        (isc.Page.isRTL() ? "inline" : "relative") + ";z-index:", // 0
                     ,  // 1 [getTableZIndex()]
                     ";'>", // 2
                     ,  // 3 [table html]
                     "</DIV>"],
...
//                        component + " went asynchronous", "printing");
    ...
    if (!showAllColumns) {
        ...
        padType = (this.cacheDOM || (isc.Browser.isIE && !isc.Browser.isIE8) ? "margin" : "padding");
        //padType = "padding";
    }
...
//    if (position != this._$within) {
        ...
        if (redrawing && (expectedRowHeight != this.getRowSize(rowNum))) {
