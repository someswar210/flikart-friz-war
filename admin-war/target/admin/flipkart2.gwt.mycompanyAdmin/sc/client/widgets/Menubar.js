...
// Set up the menuBar buttons. Should not be called directly - use 'setMenus' instead.
//		@group	drawing
//
//		@param	[newButtons]	(object[])	
//          list of button objects (object literal with 'title', 'width', etc)
//<
// Overridden to derive buttons from this.menus.
// Called to initialize the menuBar on draw, and from setMenus only.
setButtons : function (newButtons) {
    ...
    return this.Super("setButtons",[newButtons]);
},
